...
! function(t, e) {
	...
	e = function() {
		...
		var u = navigator.userAgent.match(/(iPad|iPhone|iPod)/g) ? !0 : !1;
		if (u) {
			var c = !1,
				p = function() {
					if (!c) {
						...
						i.buffer = t, i.connect(e.destination), i.start(0), console.log("start ios!"), "running" === e.state && (c = !0)
					}
				};
	...
	n = function() {
		...
		return t.prototype.sampleRate = function() {
			...
			midiToFreq: t.prototype.midiToFreq
		}
	}(i);
	var o;
	o = function() {
	...
	r = function() {
		var e = i,
			n = e.audiocontext;
		"undefined" != typeof n.createStereoPanner ? (t.Panner = function(t, e) {
			this.stereoPanner = this.input = n.createStereoPanner(), t.connect(this.stereoPanner), this.stereoPanner.connect(e)
			...
			1 === t ? (this.input.disconnect(), this.input.connect(this.left), this.input.connect(this.right)) : 2 === t && (this.splitter = n.createChannelSplitter(2), this.input.disconnect(), this.input.connect(this.splitter), this.splitter.connect(this.left, 1), this.splitter.connect(this.right, 0))
	...
	s = function() {
		...
		t.SoundFile = function(e, i, n, o) {
			...
			var r = this,
				s = new t.SoundFile(e, function() {
					"function" == typeof i && i.apply(r, arguments), r._decrementPreload()
				}, n, o);
			return s
		...
		t.SoundFile.prototype._initCounterNode = function() {
		...
		}, t.SoundFile.prototype.processPeaks = function(t, i, n, o) {
			...
			g.type = "lowpass", v.connect(g), g.connect(y.destination), v.start(0), y.startRendering(), y.oncomplete = function(i) {
				var n = i.renderedBuffer,
					o = n.getChannelData(0);
				do h = e(o, f), f -= .005; while (Object.keys(h).length < m && f >= d);
				var u = r(h),
					c = s(u, n.sampleRate),
				...
				var l = 5,
					y = a(h, p[0].tempo, n.sampleRate, l);
				t(y)
			}
		};
		var d = function(t, e) {
	...
	a = function() {
		...
		t.Amplitude = function(t) {
			...
			e.soundArray.splice(t, 1), this.input.disconnect(), this.output.disconnect(), this.input = this.processor = void 0, this.output = void 0
		}
	}(i);
	var u;
	u = function() {
		...
		t.FFT = function(t, i) {
			...
			if (t && "db" === t.toLowerCase()) return n(this), this.analyser.getFloatFrequencyData(this.freqDomain), this.freqDomain;
			o(this, this.freqDomain), this.analyser.getByteFrequencyData(this.freqDomain);
			var i = Array.apply([], this.freqDomain);
			return i.length === this.analyser.fftSize, i.constructor === Array, i
			...
			var t = e.soundArray.indexOf(this);
			e.soundArray.splice(t, 1), this.analyser.disconnect(), this.analyser = void 0
	...
	A = function() {
		...
		s.setContext(a.audiocontext), t.Signal = function(t) {
			var i = new e(t);
			return i
		}, e.prototype.fade = e.prototype.linearRampToValueAtTime, o.prototype.fade = e.prototype.fade, n.prototype.fade = e.prototype.fade, r.prototype.fade = e.prototype.fade, e.prototype.setInput = function(t) {
			t.connect(this)
		}, o.prototype.setInput = e.prototype.setInput, n.prototype.setInput = e.prototype.setInput, r.prototype.setInput = e.prototype.setInput, e.prototype.add = function(t) {
			var e = new n(t);
			return this.connect(e), e
		}, o.prototype.add = e.prototype.add, n.prototype.add = e.prototype.add, r.prototype.add = e.prototype.add, e.prototype.mult = function(t) {
			var e = new o(t);
			return this.connect(e), e
		}, o.prototype.mult = e.prototype.mult, n.prototype.mult = e.prototype.mult, r.prototype.mult = e.prototype.mult, e.prototype.scale = function(e, i, n, o) {
			var s, a;
		...
		}, o.prototype.scale = e.prototype.scale, n.prototype.scale = e.prototype.scale, r.prototype.scale = e.prototype.scale
	}(b, x, S, w, c, i);
	var P;
	P = function() {
		var e = i,
		...
		t.Oscillator = function(i, n) {
			...
			if (!this.started) {
				...
				this.oscillator && (this.oscillator.disconnect(), this.oscillator = void 0), this.oscillator = e.audiocontext.createOscillator(), this.oscillator.frequency.value = Math.abs(o), this.oscillator.type = r, this.oscillator.connect(this.output), t = t || 0, this.oscillator.start(t + e.audiocontext.currentTime), this.freqNode = this.oscillator.frequency;
	...
	F = function() {
		var e = i,
			...
			s = O,
			a = c;
		a.setContext(e.audiocontext), t.Env = function(t, i, n, o, r, a) {
		...
		}, t.Env.prototype.setRange = function(t, e) {
			this.aLevel = t || 1, this.rLevel = e || 0
		}, t.Env.prototype._setRampAD = function(t, e) {
		...
		}, t.Env.prototype.setRampPercentages = function(t, e) {
		...
		}, t.Env.prototype.setInput = function() {
			for (var t = 0; t < arguments.length; t++) this.connect(arguments[t])
		}, t.Env.prototype.setExp = function(t) {
			this.isExponential = t
		}, t.Env.prototype.checkExpInput = function(t) {
			return 0 >= t && (t = 1e-8), t
		}, t.Env.prototype.play = function(t, e, i) {
			var n = e || 0,
				i = i || 0;
			t && this.connection !== t && this.connect(t), this.triggerAttack(t, n), this.triggerRelease(t, n + this.aTime + this.dTime + i)
		}, t.Env.prototype.triggerAttack = function(t, i) {
			var n = e.audiocontext.currentTime,
				o = i || 0,
				r = n + o;
		...
		}, t.Env.prototype.triggerRelease = function(t, i) {
		...
		}, t.Env.prototype.ramp = function(t, i, n, o) {
		...
		}, t.Env.prototype.connect = function(i) {
		...
		}, t.Env.prototype.disconnect = function() {
			this.output.disconnect()
		}, t.Env.prototype.add = function(e) {
			var i = new n(e),
				o = this.mathOps.length,
				r = this.output;
			return t.prototype._mathChain(this, i, o, r, n)
		}, t.Env.prototype.mult = function(e) {
			var i = new o(e),
				n = this.mathOps.length,
				r = this.output;
			return t.prototype._mathChain(this, i, n, r, o)
		}, t.Env.prototype.scale = function(e, i, n, o) {
			var s = new r(e, i, n, o),
				a = this.mathOps.length,
				u = this.output;
			return t.prototype._mathChain(this, s, a, u, r)
		}, t.Env.prototype.dispose = function() {
			var t = e.soundArray.indexOf(this);
			e.soundArray.splice(t, 1), this.disconnect();
			try {
				this.control.dispose(), this.control = null
			} catch (i) {
				console.warn(i, "already disposed p5.Env")
			}
			for (var n = 1; n < this.mathOps.length; n++) this.mathOps[n].dispose()
		}
	}(i, x, S, w, O, c);
	var q;
	q = function() {
		function e() {
			for (var t = n.audiocontext, e = t.createBuffer(1, 2048, t.sampleRate), i = e.getChannelData(0), o = 0; 2048 > o; o++) i[o] = 1;
			var r = t.createBufferSource();
			return r.buffer = e, r.loop = !0, r
		}
		var n = i;
		t.Pulse = function(i, o) {
			t.Oscillator.call(this, i, "sawtooth"), this.w = o || 0, this.osc2 = new t.SawOsc(i), this.dNode = n.audiocontext.createDelay(), this.dcOffset = e(), this.dcGain = n.audiocontext.createGain(), this.dcOffset.connect(this.dcGain), this.dcGain.connect(this.output), this.f = i || 440;
			...
			if ("number" == typeof t) {
				...
				this.oscillator.frequency.cancelScheduledValues(o), this.oscillator.frequency.setValueAtTime(r, o + i), this.oscillator.frequency.exponentialRampToValueAtTime(t, i + e + o), this.osc2.oscillator.frequency.cancelScheduledValues(o), this.osc2.oscillator.frequency.setValueAtTime(r, o + i), this.osc2.oscillator.frequency.exponentialRampToValueAtTime(t, i + e + o), this.freqMod && (this.freqMod.output.disconnect(), this.freqMod = null)
	...
	M = function() {
		...
		t.Noise = function(e) {
			var i;
			t.Oscillator.call(this), delete this.f, delete this.freq, delete this.oscillator, i = "brown" === e ? r : "pink" === e ? o : n, this.buffer = i
	...
	Z = function() {
		...
		return t.Effect = function() {
			this.ac = e.audiocontext, this.input = this.ac.createGain(), this.output = this.ac.createGain(), this._drywet = new n(1), this.wet = this.ac.createGain(), this.input.connect(this._drywet.a), this.wet.connect(this._drywet.b), this._drywet.connect(this.output), this.connect(), e.soundArray.push(this)
			...
			var t = e.soundArray.indexOf(this);
			e.soundArray.splice(t, 1), this.input.disconnect(), this.input = void 0, this.output.disconnect(), this.output = void 0, this._drywet.disconnect(), delete this._drywet, this.wet.disconnect(), delete this.wet, this.ac = void 0
		}, t.Effect
	}(i, j);
	var X;
	X = function() {
		...
		return t.Filter = function(t) {
			...
			e.prototype.dispose.apply(this), this.biquad.disconnect(), this.biquad = void 0
		}, t.LowPass = function() {
	...
	Y = function() {
		...
		return o.prototype = Object.create(e.prototype), o.prototype.amp = function() {
			...
			n.soundArray.splice(t, 1), this.disconnect(), delete this.biquad
		}, o
	}(X, i);
	var z;
	z = function() {
		...
		return t.EQ = function(t) {
			...
			for (e.prototype.dispose.apply(this); this.bands.length > 0;) delete this.bands.pop().dispose();
			delete this.bands
		}, t.EQ
	}(Z, Y);
	var W;
	W = function() {
		...
		return t.Panner3D = function() {
			...
			e.prototype.dispose.apply(this), this.panner.disconnect(), delete this.panner
		}, t.Panner3D
	}(i, Z);
	var Q;
	Q = function() {
	...
	et = function() {
		...
		t.prototype.setBPM = function(t, e) {
			o = t;
			for (var i in n.parts) n.parts[i] && n.parts[i].setBPM(t, e)
		}, t.Phrase = function(t, e, i) {
			this.phraseStep = 0, this.name = t, this.callback = e, this.sequence = i
		}, t.Part = function(e, i) {
			this.length = e || 0, this.partStep = 0, this.phrases = [], this.isPlaying = !1, this.noLoop(), this.tatums = i || .0625, this.metro = new t.Metro, this.metro._init(), this.metro.beatLength(this.tatums), this.metro.setBPM(o), n.parts.push(this), this.callback = function() {}
	...
	it = function() {
		var e = i,
			n = K;
		return t.SoundLoop = function(t, i) {
			this.callback = t, this.musicalTimeMode = "number" == typeof this._interval ? !1 : !0, this._interval = i || 1, this._timeSignature = 4, this._bpm = 60, this.isPlaying = !1, this.maxIterations = 1 / 0;
			var o = this;
			this.clock = new n({
				callback: function(t) {
			...
			var e = t || 0;
			this.isPlaying && (this.clock.pause(e), this.isPlaying = !1)
	...
	nt = function() {
		...
		return t.Compressor = function() {
			...
			e.prototype.dispose.apply(this), this.compressor.disconnect(), this.compressor = void 0
		}, t.Compressor
	}(i, Z, o);
	var ot;
	ot = function() {
		...
		}, t.prototype.saveSound = function(i, o) {
			var r, s;
			r = i.buffer.getChannelData(0), s = i.buffer.numberOfChannels > 1 ? i.buffer.getChannelData(1) : r;
			var a = e(r, s),
				u = new window.ArrayBuffer(44 + 2 * a.length),
				c = new window.DataView(u);
			n(c, 0, "RIFF"), c.setUint32(4, 36 + 2 * a.length, !0), n(c, 8, "WAVE"), n(c, 12, "fmt "), c.setUint32(16, 16, !0), c.setUint16(20, 1, !0), c.setUint16(22, 2, !0), c.setUint32(24, 44100, !0), c.setUint32(28, 176400, !0), c.setUint16(32, 4, !0), c.setUint16(34, 16, !0), n(c, 36, "data"), c.setUint32(40, 2 * a.length, !0);
	...
	st = function() {
		...
		t.Gain = function() {
			...
			var t = e.soundArray.indexOf(this);
			e.soundArray.splice(t, 1), this.output.disconnect(), this.input.disconnect(), this.output = void 0, this.input = void 0
		}
	}(i, e);
	var at;
	at = function() {
		...
		}, t.AudioVoice.prototype._setNote = function(e) {
			var i = {
					A: 21,
					B: 23,
					C: 24,
				...
				n = i[e[0]],
				o = "number" == typeof Number(e.slice(-1)) ? e.slice(-1) : 0;
			return n += 12 * o, n = "#" === e[1] ? n + 1 : "b" === e[1] ? n - 1 : n, t.prototype.midiToFreq(n)
	...
	ut = function() {
		...
		t.MonoSynth = function() {
			n.call(this), this.oscillator = new t.Oscillator, this.env = new t.Env, this.env.setRange(1, 0), this.env.setExp(!0), this.setADSR(.02, .25, .05, .35), this.filter = new t.Filter("highpass"), this.filter.set(5, 1), this.oscillator.disconnect(), this.oscillator.connect(this.filter), this.env.disconnect(), this.env.setInput(this.oscillator), this.filter.connect(this.output), this.oscillator.start(), this.connect(), this._isOn = !1, e.soundArray.push(this)
		}, t.MonoSynth.prototype = Object.create(t.AudioVoice.prototype), t.MonoSynth.prototype.play = function(t, e, i, n) {
			var n = n || this.sustain;
			this.susTime = n, this.triggerAttack(t, e, i), this.triggerRelease(i + n)
		}, t.MonoSynth.prototype.triggerAttack = function(t, e, i) {
			var i = i || 0,
				n = "string" == typeof t ? this._setNote(t) : "number" == typeof t ? t : 440,
				o = e || 1;
			...
			n.prototype.dispose.apply(this), this.filter.dispose(), this.env.dispose();
			try {
	...
	ct = function() {
		var e = i,
			n = O;
		t.PolySynth = function(i, o) {
			this.audiovoices = [], this.notes = {}, this._newest = 0, this._oldest = 0, this.polyValue = o || 8, this.AudioVoice = void 0 === i ? t.MonoSynth : i, this._voicesInUse = new n(0), this.output = e.audiocontext.createGain(), this.connect(), this._allocateVoices(), e.soundArray.push(this)
		}, t.PolySynth.prototype._allocateVoices = function() {
			for (var t = 0; t < this.polyValue; t++) this.audiovoices.push(new this.AudioVoice), this.audiovoices[t].disconnect(), this.audiovoices[t].connect(this.output)
		...
		}, t.PolySynth.prototype.noteAttack = function(i, o, r) {
			var s, a = e.audiocontext.currentTime,
				u = r || 0,
				c = a + u,
				p = "string" == typeof i ? this.AudioVoice.prototype._setNote(i) : "number" == typeof i ? i : 440,
				h = void 0 === o ? 1 : o;
			if (void 0 !== this.notes[p] && null !== this.notes[p].getValueAtTime(c) && this.noteRelease(p, 0), this._voicesInUse.getValueAtTime(c) < this.polyValue) s = this._voicesInUse.getValueAtTime(c);
			else {
				s = this._oldest;
				var l = t.prototype.freqToMidi(this.audiovoices[this._oldest].oscillator.freq().value);
				this.noteRelease(l), this._oldest = (this._oldest + 1) % (this.polyValue - 1)
			}
			this.notes[p] = new n, this.notes[p].setValueAtTime(s, c);
			var f = null === this._voicesInUse._searchBefore(c) ? 0 : this._voicesInUse._searchBefore(c).value;
			if (this._voicesInUse.setValueAtTime(f + 1, c), this._updateAfter(c, 1), this._newest = s, "number" == typeof h) {
				var d = 1 / this._voicesInUse.getValueAtTime(c) * 2;
				h = h > d ? d : h
			}
			this.audiovoices[s].triggerAttack(p, h, u)
			...
			var n = "string" == typeof t ? this.AudioVoice.prototype._setNote(t) : "number" == typeof t ? t : this.audiovoices[this._newest].oscillator.freq().value,
				o = e.audiocontext.currentTime,
				r = i || 0,
				s = o + r;
			if (null === this.notes[n].getValueAtTime(s)) console.warn("Cannot release a note that is not already playing");
			else {
				var a = null === this._voicesInUse._searchBefore(s) ? 0 : this._voicesInUse._searchBefore(s).value;
				this._voicesInUse.setValueAtTime(a - 1, s), this._updateAfter(s, -1), this.audiovoices[this.notes[n].getValueAtTime(s)].triggerRelease(r), this.notes[n].setValueAtTime(null, s), this._newest = 0 === this._newest ? 0 : (this._newest - 1) % (this.polyValue - 1)
			}
	...
	pt = function() {
		...
		t.Distortion = function(n, o) {
			...
			i.prototype.dispose.apply(this), this.waveShaperNode.disconnect(), this.waveShaperNode = null
		}
	}(Z);
	var ht;
	ht = function() {
		var t = e;
		return t
	}(e, i, n, o, r, s, a, u, A, P, F, q, M, V, X, z, W, Q, H, $, tt, et, it, nt, ot, rt, st, ut, ct, pt, at, ut, ct)
});